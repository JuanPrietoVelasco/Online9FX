    ...
    public static void leerDatos(String ruta) throws FileNotFoundException {
        ...
        if (!clientesTxt.isEmpty()) {
            ...
            for (int i = 0; i < datosClientes.length; i++) {
                ...
                boolean alta = (datos[5].equalsIgnoreCase("true")) ? true : false;

                Cliente nuevoCliente = new Cliente(datos[0], datos[1], datos[2], datos[3], datos[4], alta);
        ...
        if (!vehiculosTxt.isEmpty()) {
            ...
            for (int i = 0; i < datosVehiculos.length; i++) {
                ...
                boolean alta = (datos[5].equalsIgnoreCase("true")) ? true : false;
                boolean disponible = (datos[6].equalsIgnoreCase("true")) ? true : false;
                switch (datos[0]) {

                    case "Furgoneta":
                        tipoVehiculo = 1;
                        //int pma, int volumen, boolean refrigerado, Tamanio tamanio
                        int pma = Integer.parseInt(datos[7]);
                        int volumen = Integer.parseInt(datos[8]);
                        boolean refrigerado = (datos[9].equalsIgnoreCase("true")) ? true : false;
                        Tamanio tamanio = null;

                        if (datos[10].equalsIgnoreCase("GRANDE")) {
                            tamanio = Enumerados.Tamanio.GRANDE;
                        } else if (datos[10].equalsIgnoreCase("MEDIANO")) {
                            tamanio = Enumerados.Tamanio.MEDIANO;
                        } else {
                            tamanio = Enumerados.Tamanio.PEQUENIO;
                        }

                        vehiculos.add(new Furgoneta(matricula, marca, modelo, cilindrada, alta,
                    ...
                    case "Deportivo":
                        ...
                        int numPuertas = Integer.parseInt(datos[7]);
                        Combustible combustible = null;

                        if (datos[8].equalsIgnoreCase("GASOLINA")) {
                            combustible = Enumerados.Combustible.GASOLINA;
                        } else if (datos[8].equalsIgnoreCase("DIESEL")) {
                            combustible = Enumerados.Combustible.DIESEL;
                        } else if (datos[8].equalsIgnoreCase("HIBRIDO")) {
                        ...
                        if (datos[9].equalsIgnoreCase("AUTOMATICO")) {
                            cambio = Enumerados.CajaCambios.AUTOMATICO;
                        } else {
                            cambio = Enumerados.CajaCambios.MANUAL;
                        }

                        boolean descapotable = (datos[10].equalsIgnoreCase("true")) ? true : false;

                        vehiculos.add(new Deportivo(matricula, marca, modelo, cilindrada, alta, numPuertas,
                    ...
                    case "Familiar":
                        ...
                        int numPuertasFami = Integer.parseInt(datos[7]);
                        ...
                        int numPlazas = Integer.parseInt(datos[9]);
                        boolean sillaBebe = (datos[10].equalsIgnoreCase("true")) ? true : false;

                        vehiculos.add(new Familiar(matricula, marca, modelo, cilindrada, alta, numPuertasFami,
        ...
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String altaClien = elemento.getElementsByTagName("alta").item(0).getChildNodes().item(0).getTextContent();
                    boolean alta = (altaClien.equalsIgnoreCase("TRUE") ? true : false);

                    Cliente cliente = new Cliente(dni, nombre, direccion, localidad, cod_postal, alta);
...
lo devuelva si este existe o null en caso contrario.*/
        ...
        if ((Controlador.Utilidades.comprobarMatricula(matricula))) {
            for (int i = 0; i < vehiculos.size(); i++) {
